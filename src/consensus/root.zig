...
pub const leader_readiness = @import("leader_readiness.zig");
...
pub const ConsensusEngine = struct {
    ...
    /// Authorized voter pubkey (if delegated)
    authorized_voter: ?core.Pubkey,
    /// Authorized voter secret (if delegated)
    ...
    /// Set the authorized voter secret
